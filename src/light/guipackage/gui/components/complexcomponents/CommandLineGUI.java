...
public class CommandLineGUI extends Component implements CommandLineGUIInterface{
    ...
    public CommandLineGUI(UnitRectangle r) {
        ...
        prefix = new Label(new UnitRectangle(5, 50, 0, 0), "[Command]>", new Font("Geneva", Font.PLAIN, 14), Styles.textDull);
        prefix.setTextYCentered(true);
        mainBox.addComponent(prefix);
        
        command = new Label(new UnitRectangle(15, 50, 0, 0), "", new Font("Geneva", Font.PLAIN, 14), Styles.textMain);
