...
public class Encoders implements UDACapable {
    ...
    public void clearAll() {
        ...
        for (GUIInterface gui : UDA.getInstance().getGUIInterfacesOfClass(EncodersGUIInterface.class)) {
            ((EncodersGUIInterface) gui).update();
        }
    }
    ...
    public void set(Encoder encoder, double value) {
        ...
        for (GUIInterface gui : UDA.getInstance().getGUIInterfacesOfClass(EncodersGUIInterface.class)) {
            ((EncodersGUIInterface) gui).updateEncoders();
        }
    }
    ...
    */
    public void update() {
        for (GUIInterface gui : UDA.getInstance().getGUIInterfacesOfClass(EncodersGUIInterface.class)) {
            ((EncodersGUIInterface) gui).updatePages();
            ((EncodersGUIInterface) gui).updateEncoders();
        }
    }
}
